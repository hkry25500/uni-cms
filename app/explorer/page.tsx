...
export default function ExplorerPage({ dirpath }: any) {
    ...
    return (
        <>
            <div className="min-h-screen px-6 py-6 bg-yellow-50" onContextMenu={handleRightClick}>

                <nav className="flex px-5 py-3 text-gray-800 border border-gray-100 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
