...
export default function ItemFolder({ content, onClick, onRefresh }: {
    content: any;
    onClick: () => void;
    onRefresh: () => void;
}) {
        ...
        <>
            {
                !inEditing ?
                    <>
                        <div className="block relative transition hover:scale-105 hover:-rotate-1 w-full max-w-[324px] cursor-pointer" onClick={onClick} onContextMenu={openContextMenu}>
                            <div className="block">
